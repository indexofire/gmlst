...
本文说明 `gmlst` 的整体结构、数据流，以及各个主要职责在仓库中的位置。安装和命令用法请参考 [`docs/installation.md`](../installation.md)、[`docs/quickstart.md`](../quickstart.md)、[`docs/commands.md`](../commands.md) 和 [`docs/providers.md`](../providers.md)。
...
`gmlst/database/cache.py` 是核心缓存管理器。默认根目录是 `~/.cache/gmlst`，除非通过 `GMLST_CACHE_DIR` 覆盖。
...
- 架构和贡献文档放在 `docs/`
- 中文翻译放在 `docs/zh/`
- provider 参考文档位于 [`docs/providers.md`](../providers.md)
